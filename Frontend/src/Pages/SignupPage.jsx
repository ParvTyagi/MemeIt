...
const SignupPage = () => {
  ...
  const HandleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('SignUp error:', error.response?.data?.error || "Sign Up failed");
      ...
      <div className='flex flex-col justify-center items-center p-6 sm:p-12'>
        <div className='w-full max-w-md space-y-8'>
          ...
          <form className='flex flex-col items-center gap-2 mt-4' onSubmit={HandleSubmit}>
            <label className='self-start ml-17' htmlFor="fullName">Full Name:</label>
          ...
          <div className="flex flex-col items-center">
            <p className="mt-2 text-gray-600">
              ...
              <Link to="/login" className="ml-1 text-[#7243e7] hover:underline">
                Log In
              </Link>
            </p>
          </div>
